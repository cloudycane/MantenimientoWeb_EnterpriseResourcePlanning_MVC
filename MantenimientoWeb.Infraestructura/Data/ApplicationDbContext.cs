    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategoriaProductoModel>().HasData(
                new CategoriaProductoModel { Id = 1, Nombre = "Productos de Categoría A", Descripcion = "Los productos de Categoría A son los más importantes para la empresa. " +
                ...
                new CategoriaProductoModel { Id = 2, Nombre = "Productos de Categoría B", Descripcion = "Los productos de Categoría B son las que tienen una importancia y rotación moderada para la empresa." +
                ...
                new CategoriaProductoModel { Id = 3, Nombre = "Productos de Categoría C", Descripcion = "Los productos de Categoría C serán las más numerosas, pero también las que menos ingresos aportan a la empresa. Pueden suponer más del 50% de" +
